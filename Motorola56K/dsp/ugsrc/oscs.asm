...
;;
;;  SOURCE
;;      /usr/local/lib/dsp/ugsrc/oscs.asm
;;
;;  SEE ALSO
;;      /usr/local/lib/dsp/ugsrc/oscm.asm - osc with mask on wavetable index (allows negative inc)
...
; Set up data alu regs from state held in memory arguments
          ...
          move l:(R_I1)P_L,Y        ; Y = frequency (phase increment)
          move l:(R_I1),B           ; B = current phase
; 1st sample
...
pf\_oscs_\ic\_wave1 
          ...
          move B10,l:(R_I1)P_L      ; save phase in arg blk
          move R_I1,x:LARGS,R_I1   ; Put L arg pointer
          endm
