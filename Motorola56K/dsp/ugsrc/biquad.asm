...
;;  --------------------
;;  04/27/87/jos - initial file created from /usr/local/lib/dsp/ugsrc/template.doc
;;  05/19/87/jos - passed test/tbiquad.asm
;;  07/04/91/jos - changed parameter names {a,b}{1,2} to {a,b}{1,2}o2
;;
;;------------------------------ DOCUMENTATION ---------------------------
;;  NAME
...
biquad macro pf,ic,sout,aout0,sinp,ainp0,s20,s10,go20,a2o20,a1o20,b2o20,b1o20
               ...
               new_yarg pf\_biquad_\ic\_,a2o2,a2o20 ; twice-delayed out coeff
               new_yarg pf\_biquad_\ic\_,a1o2,a1o20 ; once-delayed out coeff
               new_yarg pf\_biquad_\ic\_,b2o2,b2o20 ; twice-delayed input coeff
               new_yarg pf\_biquad_\ic\_,b1o2,b1o20 ; once-delayed input coeff
