...
;;  --------------------
;;  10/16/87/jos - initial file created from /usr/local/lib/dsp/ugsrc/onezero.asm
...
;;
;;  SOURCE
;;      /usr/local/lib/dsp/ugsrc/onepole.asm
;;
;;  SEE ALSO
...
onepole macro pf,ic,sout,aout0,sinp,ainp0,s0,bb00,aa10
             ...
             new_xarg pf\_onepole_\ic\_,s,s0         ; once delayed output
