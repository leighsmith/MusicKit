; reg_defines.asm - MNEMONICS FOR ADDRESS ALU REGISTERS
...
;;
	  ...
	  define P_L   '+'    ; l arg post-increment/decrement
	  ...
	  define R_IO2  'r2'  ; SSI input system pointer
	  ...
	  define N_IO2 'n2'   ;  SSI input system pointer
	  ...
	  define M_IO2 'm2'   ;  SSI input system pointer
