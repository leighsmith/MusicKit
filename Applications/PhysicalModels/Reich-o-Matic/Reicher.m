...
@implementation Reicher: NSObject

static MKOrchestra *theOrch;
static MKSynthInstrument *theIns[NUMFLUTES];
static id theRand;
static int going = 0;

static MKNote *theNote[NUMFLUTES];
static MKNote *theNoteOn[LBREATH*NUMFLUTES][ARRNOTES][NCYCS];
static MKNote *theNoteOff[LBREATH*NUMFLUTES][ARRNOTES][NCYCS];
static MKNote *theNoteRun[NUMFLUTES][ARRNOTES][RUNNOTES];
static MKNote *theNoteUpdate[NUMFLUTES];
...
// phrase
	...
	[[MKConductor defaultConductor] sel:@selector(doPulsing) to:self withDelay:playtime argCount:0];
...
- doCanon
{
	...
	[[MKConductor defaultConductor] sel:@selector(doCanon) to:self withDelay:playtime argCount:0];
...
- doPhasing
{
	...
	[[MKConductor defaultConductor] sel:@selector(doPhasing) to:self withDelay:playtime argCount:0];
...
-doInterlock
{
	...
	[[MKConductor defaultConductor] sel:@selector(doInterlock) to:self withDelay:(CYCMEASURE * 7) argCount:0];
