...
/*!
  ...
  @brief Returns the number of memory arguments in the receiver's DSP
  code.
...
/*!
  @return Returns an id.
  @brief Invoke this method when the receiver is is created, after its code
  is loaded.
...
/*!
  ...
  Returns the amount of time needed to finish; The default
  returns 0.0.
*/
-(double ) finishSelf; 
...
/*!
  ...
  @brief Returns the receiver's status, one of MK_idle, MK_running, and
  MK_finishing.
...
/*!
  ...
  @brief Returns a pointer to the structure that describes the receiver's
  location on the DSP.
...
/*!
  ...
  @return Returns a BOOL.
  @brief Returns <b>YES</b> if the receiver is executed after
  <i>aUnitGenerator</i>.

  Execution order is determined by comparing
...
/*!
  @return Returns a BOOL.
  @brief Returns YES if the receiver has been allocated (by its MKOrchestra),
  NO if it hasn't.
...
/*!
  @return Returns an id.
  @brief You never invoke this method directly, it's invoked from
  <b>free</b>.
