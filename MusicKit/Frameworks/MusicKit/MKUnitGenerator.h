...
/*!
  @method masterUGPtr
  @result Returns a MKMasterUGStruct *.
  @discussion Returns the receiver's master structure.  A subclass responsibility,
...
/*!
  @method classInfo
  @result Returns a MKLeafUGStruct *.
  @discussion Returns the receiver's leaf structure.  A subclass responsibility,
              this method is automatically generated by <b>dspwrap</b>.
*/
...
/*!
  ...
  @discussion Returns the number of memory arguments in the receiver's DSP
              code.
*/
...
/*!
  ...
  @discussion You never invoke this method.  It's invoked by the MKOrchestra if it
...
/*!
  ...
  @discussion A subclass can override this method to reduce the command stream on
              an argument-by-argument basis, returning <b>YES</b> if <i>arg</i>
              should be optimized, <b>NO</b> if it shouldn't.  The default
              implementation always returns <b>NO</b>.
...
/*!
  @method init
  @result Returns an id.
  @discussion Invoke this method when the receiver is is created, after its code
              is loaded.  If this method returns <b>nil</b>, the receiver is
              ...
              returns <b>nil</b>.  The default implementation returns
              self.
*/
- init;
...
/*!
  @method run
  @result Returns an id.
  @discussion Starts the receiver by sending <b>[self runSelf]</b> and then sets
              its status to MK_running.  You never subclass this method;
              <b>runSelf</b> provides subclass runtime instructions.  A
              MKUnitGenerator must be sent <b>run</b> before it can be
              used.
*/
- run;
...
/*!
  @method runSelf
  @result Returns an id.
  @discussion Subclass implementation of this method provides instructions for
...
/*!
  ...
  @discussion Finishes the receiver's activity by sending <b>finishSelf</b> and
              then sets its status to MK_finishing.  You never subclass this
              method; <b>finishSelf</b> provides subclass finishing instructions. 
              Returns the value of <b>[self finishSelf]</b>, which is taken as the
              amount of time, in seconds, before the receiver can be
              idled.
*/
-(double ) finish; 
...
/*!
  @method finishSelf
  @result Returns a double.
  @discussion A subclass may override this method to provide instructions for
              finishing.  Returns the amount of time needed to finish; The default
              returns 0.0.
*/
-(double ) finishSelf; 
...
/*!
  @method idle
  @result Returns an id.
  @discussion Idles the receiver by sending <b>[self idleSelf]</b> and then sets
              its status to MK_idle.  You never subclass this method;
              <b>idleSelf</b> provides subclass idle instructions.  The idle state
              is defined as the UnitGenerator's producing no output.
*/
- idle;
...
/*!
  ...
  @discussion Returns the receiver's status, one of MK_idle, MK_running, and
              MK_finishing.
*/
-(int ) status; 
...
/*!
  ...
  @discussion Returns a pointer to the structure that describes the receiver's
...
/*!
  ...
  @result Returns a BOOL.
  @discussion Returns <b>YES</b> if the receiver is executed after
...
/*!
  @method argCount
  @result Returns an unsigned.
  @discussion Returns the number of memory arguments in the receiver's DSP code. 
              The same value is returned by the <b>argCount</b> class
              method.
*/
- (unsigned int) argCount; 
...
/*!
  @method classInfo
  @result Returns a MKLeafUGStruct *.
  @discussion Returns a pointer to the receiver's leaf structure.  The same
              structure pointer is returned by the <b>classInfo</b> class
              method.
*/
- (MKLeafUGStruct *) classInfo; 
...
/*!
  @method resources
  @result Returns a MKOrchMemStruct *.
  @discussion Return a pointer to the structure that describes the receiver's
              memory requirements.  Each field of the structure represents a
...
/*!
  ...
  @result Returns an id.
  @discussion This method always returns the MKOrchestra class.  It's provided for
              applications that extend the Music Kit to use other synthesis
...
/*!
  ...
  @discussion Invoked by the MKOrchestra to determine whether the receiver may be
              freed.  Returns YES if it can, NO if it can't.  (A MKUnitGenerator can
...
/*!
  @method isAllocated
  @result Returns a BOOL.
  @discussion Returns YES if the receiver has been allocated (by its MKOrchestra),
              NO if it hasn't.
*/
-(BOOL ) isAllocated; 

/*!
  @method setDatumArg:to:
  @param  argNum is an unsigned.
  @param  val is a DSPDatum.
  @result Returns an id.
  @discussion Sets the datum-valued argument <i>argNum</i> to <i>val</i>.  If
              <i>argNum</i> is an L-space argument (two 24-bit words), its
...
/*!
  @method setDatumArg:toLong:
  @param  argNum is an unsigned.
  @param  val is a DSPLongDatum *.
  @result Returns an id.
  @discussion Sets the datum-valued argument <i>argNum</i> to <i>val</i>.  If
              <i>argNum</i> isn't an L-space argument (it can't accommodate a
...
/*!
  @method setAddressArg:to:
  @param  argNum is an unsigned.
  @param  memoryObj is an id.
  @result Returns an id.
  @discussion Sets the addresst-valued argument <i>argNum</i> to <i>memoryObj</i>.
              If <i>argNum</i> (as an index) is out of bounds, an error is
              generated and <b>nil</b> is returned.  Otherwise returns the
              receiver.  This is ordinarily only invoked by a subclass.
*/
...
/*! 
  @method setAddressArg:toInt:
  @param  argNum is an unsigned.
  @param  address is a DSPAddress.
  @result Returns an id.
  @discussion Sets the addresst-valued argument argNum to address.
...
/*!
  @method setAddressArgToSink:
  @param  argNum is an unsigned.
  @result Returns an id.
  @discussion Sets the address-valued argument <i>argNum</i> to the sink
              patchpoint.  (Sink is a location which, by convention, is never
...
/*!
  @method setAddressArgToZero:
  @param  argNum is an unsigned.
  @result Returns an id.
  @discussion Sets the address-valued argument <i>argNum</i> to a zero patchpoint.
...
/*!
  ...
  @discussion Returns the memory space to or from which the address-valued
              argument <i>argNum</i> reads or writes.  If <i>argNum</i> isn't an
              address-valued argument, returns DSP_MS_N.
*/
...
/*!
  @method freeSelf
  @result Returns an id.
  @discussion You never invoke this method directly, it's invoked from
              <b>free</b>.  A subclass may implement this method to provide
...
/*!
  ...
  @result Returns an int.
  @discussion Returns a low integer that uniquely identifies this MKUnitGenerator. 
