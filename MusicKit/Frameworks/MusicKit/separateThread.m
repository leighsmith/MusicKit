...
/* The following method handles Mach messages received by the App thread. 
 * This replaces the previously defined function because instead of DPSAddPort specifying a function,
 * DPSAddPort() has been replaced with:
