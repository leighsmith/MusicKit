...
// for A=440Hz tunings in twelve tone equal temperament.
...
- copyWithZone: (NSZone *) zone
{
    ...
    MKTuningSystem *newObj = (MKTuningSystem *) [[MKTuningSystem allocWithZone: zone] init];
    
    [newObj->frequencies release];
