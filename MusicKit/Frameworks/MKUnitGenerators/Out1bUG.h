...
/*!
  @class Out1bUG
  @brief <b>Out1bUG</b> simply writes its input patchpoint to the right channel.
...
/*!
  ...
  @brief Sets the factor by which the input signal is scaled for the right channel.
