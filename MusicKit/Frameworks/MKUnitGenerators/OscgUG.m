...
/* 
  ...
  08/17/90/daj - Internationalized strings.
...
//#define WAVETABLE_STR NXLocalStringFromTableInBundle(_MK_ERRTAB,_MKErrorBundle(),"Oscg Wavetable","Wavetable","This string occurs in the context of a larger error message: 'Wavetable must be set before...' This error is rarely if ever seen by the user.")
