/*
  ...
  Description:
    OscgafiUG  - from dsp macro /usr/lib/dsp/ugsrc/oscgafi.asm (see source for details).
...
/*!
  @class OscgafiUG
  @abstract <b>OscgafiUG</b> is the same as <b>OscgafUG</b>, but it implements
            a high-quality interpolating oscillator.
  @discussion
...
<i>d</i>	table space
*/
#ifndef __MK_OscgafiUG_H___
#define __MK_OscgafiUG_H___

#import "OscgafUGs.h"

@interface OscgafiUG: OscgafUGs
