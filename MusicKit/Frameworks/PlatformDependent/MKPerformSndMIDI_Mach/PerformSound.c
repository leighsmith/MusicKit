...
/*
// $Log$
// Revision 1.1  2001/02/15 19:12:08  skot
// Added some stub files from silent MKPerformSndMIDI ready for sndkit2-erization
//
// Revision 1.1.1.1  2000/12/07 19:32:34  leigh
// Initial revision
//
...
PERFORM_API void SNDStreamNativeFormat(SndSoundStruct *s)
{
}

PERFORM_API BOOL SNDStreamStart()
{
    return TRUE;
}

PERFORM_API void SNDStreamStop()
{
}
...
{
  if(!initialised)
      return 1; //SND_ERR_NOT_RESERVED;  // invalid sound structure.
 
  if(soundStruct->magic != SND_MAGIC)
      return 1; //SND_ERR_CANNOT_PLAY; // probably SND_ERROR_NOT_SOUND is more descriptive, but this matches SoundKit specs.

  return 0; //SND_ERR_NONE;
}
