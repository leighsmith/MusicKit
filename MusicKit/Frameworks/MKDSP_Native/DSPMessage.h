...
MKDSP_API int DSPDataIsAvailable(void);
/*
 * Return nonzero if RXDF is set.
 */

MKDSP_API int DSPAwaitData(int msTimeLimit);
/*
...
MKDSP_API int DSPMessageIsAvailable(void);
/*
...
MKDSP_API int DSPAwaitMessages(int msTimeLimit);
/*
...
MKDSP_API int DSPReadMessages(int msTimeLimit);
/*
...
MKDSP_API int DSPMessageGet(int *msgp);
/*
...
MKDSP_API int DSPFlushMessages(void);
/*
 * Flush any unread messages from the DSP.
 */

MKDSP_API int DSPFlushMessageBuffer(void);
/*
...
MKDSP_API int DSPBreakPoint(int dsp_bp_msg);
/*
...
MKDSP_API int DSPMessagesOff(void);
/* 
...
MKDSP_API int DSPMessagesOn(void);
/* 
...
MKDSP_API int DSPAwaitAnyMessage(
...
MKDSP_API int DSPAwaitUnsignedReply(
...
MKDSP_API int DSPHostMessage(int msg);
/* 
...
MKDSP_API int DSPMKHostMessageTimed(DSPFix48 *aTimeStampP, int msg);
...
MKDSP_API int DSPMKHostMessageTimedFromInts(
...
MKDSP_API int DSPCallV(DSPAddress hm_opcode,int nArgs,...);
/*
...
MKDSP_API int DSPMKStartReaders(void);
/* 
...
MKDSP_API int DSPMKStopMsgReader(void);
/* 
...
MKDSP_API int DSPMKFlushTimedMessages(void);
/* 
...
MKDSP_API int DSPMKCallTimedV(DSPFix48 *aTimeStampP,int hm_opcode,int nArgs,...);
/*
...
MKDSP_API int DSPMKAwaitEndOfTime(DSPFix48 *aTimeStampP);
/* 
