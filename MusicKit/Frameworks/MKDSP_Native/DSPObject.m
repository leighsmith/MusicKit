...
static thread_t *s_wd_thread=NULL;
...
static thread_t *s_rd_thread=NULL;
...
static thread_t *s_dsp_err_thread=NULL;
static thread_t *s_dsp_msg_thread=NULL;
...
#endif
    // LMS s_dsp_err_thread[s_idsp]=cthread_fork((thread_fn_t)s_dsp_err_reader,(void *)s_idsp);
    return 0;
}    
