#ifndef __MK__Wave1i_H___
#define __MK__Wave1i_H___
...
//#define WAVEUG(ugname) NX_ADDRESS(synthElements)[WAVENUM(ugname)] //sb
#define WAVEUG(ugname) [synthElements objectAtIndex:WAVENUM(ugname)]
