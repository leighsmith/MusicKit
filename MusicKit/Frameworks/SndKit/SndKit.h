...
// definitions controlling configuration, such as inclusion of libraries.
// This will probably be generated by some sort of autoconf process, someday.
#define SND_MP3_ENCODER
