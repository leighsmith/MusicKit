...
int writeFilter(SND_HWORD Imp[], SND_HWORD ImpD[], SND_UHWORD LpScl, SND_UHWORD Nmult, SND_UHWORD Nwing);
/*
...
int readFilter(char *filterFile,
	       SND_HWORD **ImpP, SND_HWORD **ImpDP, SND_UHWORD *LpScl, 
...
SND_WORD FilterUp(SND_HWORD Imp[], SND_HWORD ImpD[], SND_UHWORD Nwing, BOOL Interp,
	      SND_HWORD *Xp, SND_HWORD Inc, SND_HWORD Ph);

SND_WORD FilterUD(SND_HWORD Imp[], SND_HWORD ImpD[], SND_UHWORD Nwing, BOOL Interp,
