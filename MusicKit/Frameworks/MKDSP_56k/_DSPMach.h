...
extern msg_header_t *_DSP_simple_request_msg (
	port_t	cmd_port,
	port_t	reply_port,
        int messageType);				       

extern void _DSP_free_simple_request_msg(msg_header_t **msg);
...
msg_header_t *_DSP_dsp_read_data(
	msg_header_t *msg, 		// message frame
