#ifndef __MK_dsp_memory_map_mk_1.0_H___
#define __MK_dsp_memory_map_mk_1.0_H___
/* $Id$
Written by dspmsg from system symbols.

This include file contains definitions for Music Kit memory addresses.
These definitions depend heavily on /usr/local/lib/dsp/smsrc/config.asm,
and they tend to change every time the DSP system code is modified.  Use of
...
/***** GLOBAL SYMBOLS *****/
#define DSPMK_DEGMON_FLAG	 0x000035
#define DSPMK_DEGMON_FLAG2	 0x000037
#define DSPMK_DEGMON_H	 0x00007f
#define DSPMK_DEGMON_HCR	 0x00003b
#define DSPMK_DEGMON_HPD2	 0x000036
#define DSPMK_DEGMON_IPR	 0x00003a
#define DSPMK_DEGMON_L	 0x000034
#define DSPMK_DEGMON_N	 0x00004c
#define DSPMK_DEGMON_PC	 0x000039
#define DSPMK_DEGMON_RUN_LOC	 0x000047
#define DSPMK_DEGMON_SR	 0x000038
#define DSPMK_DEGMON_SR2	 0x00003c
#define DSPMK_DEGMON_TRACER_LOC	 0x000059
#define DSPMK_HE_USR	 0x0030d9
...
#define DSPMK_LHE_USG	 0x00a0d9
#define DSPMK_LHE_USR	 0x0030d9
...
#define DSPMK_LLE_USR	 0x0030da
#define DSPMK_LLI_SYS	 0x000000
#define DSPMK_LLI_USR	 0x0000f6
#define DSPMK_NAE_SYS	 0x000f26
...
#define DSPMK_NXE_USG	 0x0000da
#define DSPMK_NXE_USR	 0x000eda
...
#define DSPMK_XHE_USG	 0x00a0d9
#define DSPMK_XHE_USR	 0x0030d9
...
#define DSPMK_YLE_USR	 0x0030da
#define DSPMK_YLI_RAM	 0x000000
#define DSPMK_YLI_ROM	 0x000100
#define DSPMK_YLI_SYS	 0x000000
#define DSPMK_YLI_USR	 0x000004
#define DSPMK_NPE_SYSEP_FREE	 0x0008c8
#define DSPMK_SYS_REV	 0x000011
#define DSPMK_SYS_VER	 0x000001

/***** X SYMBOLS *****/
#define DSPMK_X_ABORT_A1	 0x00377b
#define DSPMK_X_ABORT_DMASTAT	 0x003779
#define DSPMK_X_ABORT_HCR	 0x00377e
#define DSPMK_X_ABORT_HSR	 0x00377f
#define DSPMK_X_ABORT_M_IO	 0x003783
#define DSPMK_X_ABORT_RUNSTAT	 0x003778
#define DSPMK_X_ABORT_R_HMS	 0x003780
#define DSPMK_X_ABORT_R_I1	 0x003781
#define DSPMK_X_ABORT_R_IO	 0x003782
#define DSPMK_X_ABORT_SP	 0x00377c
#define DSPMK_X_ABORT_SR	 0x00377d
#define DSPMK_X_ABORT_X0	 0x00377a
#define DSPMK_X_DMASTAT	 0x000001
#define DSPMK_X_DMA_REB	 0x00379c
#define DSPMK_X_DMA_REN	 0x00379d
#define DSPMK_X_DMA_REP	 0x00379e
#define DSPMK_X_DMA_RFB	 0x00379a
#define DSPMK_X_DMA_R_M	 0x003758
#define DSPMK_X_DMA_WEB	 0x003799
#define DSPMK_X_DMA_WFB	 0x003796
#define DSPMK_X_DMA_WFN	 0x003798
#define DSPMK_X_DMA_WFP	 0x003797
...
#define DSPMK_X_MIDI_MSG	 0x003788
#define DSPMK_X_NCHANS	 0x003786
#define DSPMK_X_NCLIP	 0x003787
...
#define DSPMK_X_SAVED_R_I1_HMLIB	 0x003785
#define DSPMK_X_SAVED_R_I2	 0x00375b
#define DSPMK_X_SAVED_R_O	 0x00375c
#define DSPMK_X_SAVED_SR	 0x003784
...
#define DSPMK_X_SCI_COUNT	 0x003789
#define DSPMK_X_SCRATCH1	 0x003776
#define DSPMK_X_SCRATCH2	 0x003777
#define DSPMK_X_SSIRP	 0x00378c
#define DSPMK_X_SSIWP	 0x00378d
#define DSPMK_X_SSI_PHASE	 0x003795
#define DSPMK_X_SSI_RFP	 0x00379b
#define DSPMK_X_SSI_SAVED_A0	 0x003790
#define DSPMK_X_SSI_SAVED_A1	 0x003791
#define DSPMK_X_SSI_SAVED_A2	 0x003792
#define DSPMK_X_SSI_SAVED_M_I1	 0x00378f
#define DSPMK_X_SSI_SAVED_R_I1	 0x00378e
#define DSPMK_X_SSI_SAVED_X0	 0x003793
#define DSPMK_X_SSI_SAVED_X1	 0x003794
#define DSPMK_X_START	 0x00374c
#define DSPMK_X_TICK	 0x000002
#define DSPMK_X_TMQRP	 0x00378a
#define DSPMK_X_TMQWP	 0x00378b
