...
;;
;;  SOURCE
;;      /usr/local/lib/dsp/ugsrc/oscw.asm
;;
;;  SEE ALSO
;;      /usr/local/lib/dsp/ugsrc/oscs.asm - simplest osc (also 4 instr. inner loop)
;;      /usr/local/lib/dsp/ugsrc/oscm.asm - masked wavetable index (for negative inc)
;;      /usr/local/lib/dsp/ugsrc/osci.asm - linear interpolation on table lookup
;;
;;  ALU REGISTER USE
;;      X0 = c
;;      Y0 = s
