...
;; --------------------
;; 04/12/88/jos - initial file created from /usr/local/lib/dsp/ugsrc/template
...
;;      in /usr/local/lib/dsp/smsrc/beginend.asm (used also for unit-generator development
...
;;
;;  SOURCE
;;      /usr/local/lib/dsp/ugsrc/orchloopbegin.asm
;;
;;  SEE ALSO
;;      /usr/local/lib/dsp/smsrc/beginend.asm(beg_orcl) - invoked by orchloopbegin
;;
