...
;; Author - J.O. Smith
;;
;; Included by /usr/local/lib/dsp/smsrc/allocsys.asm
;; The space allocation is specified in /usr/local/lib/dsp/smsrc/memmap.asm 
;; (NYE_SYS).
;; *** NOTE *** The number of y system variables (excluding io buffers) 
;; provided for by the NYE_SYS variable in /usr/local/lib/dsp/smsrc/memmap.asm
;; must be used here exactly.  Also, the io buffers should be AFTER the y vars.
