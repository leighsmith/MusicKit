...
;; USER MEMORY ALLOCATION
;;
; USER DATA MEMORY INITIALIZATION (allocation done in /usr/local/lib/dsp/smsrc/memmap.asm)
...
; was broken with respect to it, and special macros for this case appear
...
; instead of passing a single 48-bit word (which used to be impossible).  If I
