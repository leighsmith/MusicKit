...
/* dsp_memory_map_Array Processing.h - written by _DSPMakeIncludeFiles() from system symbols.

This include file contains definitions for AP memory addresses.
...
#define DSPAP_LHE_USG	 0x00ab9e
#define DSPAP_LHE_USR	 0x003b9e
...
#define DSPAP_LLE_USR	 0x003b9f
#define DSPAP_LLI_SYS	 0x000000
#define DSPAP_LLI_USR	 0x0000f6
#define DSPAP_NAE_SYS	 0x000461
...
#define DSPAP_NXE_SYS	 0x00002c
#define DSPAP_NXE_USG	 0x000b9f
#define DSPAP_NXE_USR	 0x00199f
...
#define DSPAP_PHE_SYS	 0x003e73
#define DSPAP_PHE_SYSEP	 0x003fff
#define DSPAP_PHE_USG	 0x00a1ff
#define DSPAP_PHE_USR	 0x0021ff
...
#define DSPAP_XHE_USG	 0x00ab9e
#define DSPAP_XHE_USR	 0x003b9e
...
#define DSPAP_XLE_SYS	 0x003e74
#define DSPAP_XLE_USG	 0x00a000
#define DSPAP_XLE_USR	 0x002200
...
#define DSPAP_YLE_USR	 0x003b9f
#define DSPAP_YLI_RAM	 0x000000
#define DSPAP_YLI_ROM	 0x000100
#define DSPAP_YLI_SYS	 0x000000
#define DSPAP_YLI_USR	 0x000002
#define DSPAP_NPE_SYSEP_FREE	 0x00018c
#define DSPAP_SYS_REV	 0x000009
#define DSPAP_SYS_VER	 0x000000

/***** X SYMBOLS *****/
#define DSPAP_X_DMASTAT	 0x000001
#define DSPAP_X_DMA_R_M	 0x003e80
#define DSPAP_X_DMA_W_M	 0x003e81
#define DSPAP_X_DMQRP	 0x003e9c
#define DSPAP_X_DMQWP	 0x003e9d
#define DSPAP_X_DSPMSG_A1	 0x003e7c
#define DSPAP_X_DSPMSG_B0	 0x003e7b
#define DSPAP_X_DSPMSG_B1	 0x003e7a
#define DSPAP_X_DSPMSG_B2	 0x003e79
#define DSPAP_X_DSPMSG_M_O	 0x003e7e
#define DSPAP_X_DSPMSG_R_O	 0x003e7d
#define DSPAP_X_DSPMSG_X0	 0x003e78
#define DSPAP_X_DSPMSG_X1	 0x003e77
#define DSPAP_X_HMSRP	 0x003e75
#define DSPAP_X_HMSWP	 0x003e76
#define DSPAP_X_SAVED_A0	 0x003e91
#define DSPAP_X_SAVED_A1	 0x003e90
#define DSPAP_X_SAVED_A2	 0x003e8f
#define DSPAP_X_SAVED_B0	 0x003e94
#define DSPAP_X_SAVED_B1	 0x003e93
#define DSPAP_X_SAVED_B2	 0x003e92
#define DSPAP_X_SAVED_HOST_RCV1	 0x003e95
#define DSPAP_X_SAVED_HOST_RCV2	 0x003e96
#define DSPAP_X_SAVED_HOST_XMT1	 0x003e97
#define DSPAP_X_SAVED_HOST_XMT2	 0x003e98
#define DSPAP_X_SAVED_M_HMS	 0x003e9b
#define DSPAP_X_SAVED_M_I1	 0x003e88
#define DSPAP_X_SAVED_M_I2	 0x003e89
#define DSPAP_X_SAVED_M_O	 0x003e8a
#define DSPAP_X_SAVED_N_HMS	 0x003e9a
#define DSPAP_X_SAVED_N_I1	 0x003e85
#define DSPAP_X_SAVED_N_I2	 0x003e86
#define DSPAP_X_SAVED_N_O	 0x003e87
#define DSPAP_X_SAVED_REGISTERS	 0x003e82
#define DSPAP_X_SAVED_R_HMS	 0x003e99
#define DSPAP_X_SAVED_R_I1	 0x003e82
#define DSPAP_X_SAVED_R_I2	 0x003e83
#define DSPAP_X_SAVED_R_O	 0x003e84
#define DSPAP_X_SAVED_X0	 0x003e8c
#define DSPAP_X_SAVED_X1	 0x003e8b
#define DSPAP_X_SAVED_Y0	 0x003e8e
#define DSPAP_X_SAVED_Y1	 0x003e8d
#define DSPAP_X_SCRATCH1	 0x003e9e
#define DSPAP_X_SCRATCH2	 0x003e9f
#define DSPAP_X_START	 0x003e74
#define DSPAP_X_TICK	 0x000002
#define DSPAP_X_XHM_R_I1	 0x003e7f
...
#define DSPAP_Y_TICK	 0x000002
#define DSPAP_Y_TINC	 0x000003
#define DSPAP_Y_ZERO	 0x000000

/***** L SYMBOLS *****/
#define DSPAP_L_STATUS	 0x000001
#define DSPAP_L_TICK	 0x000002
#define DSPAP_L_TINC	 0x000003
