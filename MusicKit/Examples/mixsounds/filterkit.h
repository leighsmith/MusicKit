#ifndef __MK_filterkit_H___
#define __MK_filterkit_H___
/*
 * FILE:filterkit.h
 *   BY: Christopher Lee Fraley (cf0v@andrew.cmu.edu)
 * DATE: 17-JUN-88
 * VERS: 1.0  (20-JUN-88, 3:10pm)
 *
 * Modification History:
 *	04/23/90/mtm	Made declarations into function prototypes.
 *			Add comments.  Import stdefs.h.
 *			Removed unreferenced cubic().
 */
