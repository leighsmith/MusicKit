 ...
 *	03/06/84/jos	Initial SAIL version at CCRMA
 *	07/06/88/clf	Initial C translation
 *	04/23/90/mtm	Made function prototypes.
 *			Made local functions static
 *			Added static getstr()
 *	07/18/90/jos	Last two arguments of FilterUp() were reversed!
 *	07/19/90/jos	Changed LpFilter frq arg from Froll to 0.5*Froll!
 *	07/19/90/jos	Added default print in prompt. Changed defaults
 *	07/19/90/jos	Changed '*' to '-' in 2nd temp eqn in LpFilter!
 *	06/12/91/jos	Changed readFilter() to malloc Imp and ImpD
 *	12/18/93/jos	Incorporated latest version of filterUp() & filterUD()
 */

char filterkitVERSION[] = "2.2  (18-Dec-93 jos)";
