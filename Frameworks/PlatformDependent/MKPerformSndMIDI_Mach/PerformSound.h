...
typedef struct {
   ...
   void*          streamData;
        // stub to hold the SNDStruct + data buffers coming up from the CoreAudio / MKPerformSndMidi layer
} SNDStreamBuffer;

typedef void (*SNDStreamProcessor)(double, SNDStreamBuffer, SNDStreamBuffer, void*); 
